...
import { TimbermanScene } from "./scenes/TimbermanScene";
...
export const createGame = (parent: string, handlers?: GameHandlers) => {
  ...
  game.registry.set("handlers", handlers ?? {});
